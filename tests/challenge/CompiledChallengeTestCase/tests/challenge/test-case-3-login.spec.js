 ...
 */
async function getLoginFormElements(page) {
 ...
 */
async function checkFormExists(usernameField) {
...
test_1.test.describe('Test Case 3: Login Functionality', {
     ...
     */
    (0, test_1.test)('should successfully log in with valid credentials', async ({ page, baseURL }) => {
        ...
        (0, test_1.expect)(hasError, 'No error message should be displayed').toBe(false);
        (0, test_1.expect)(hasSuccessMessage, 'Success message must be visible').toBe(true);
        (0, test_1.expect)(notOnLoginPage, 'Must be redirected away from login page').toBe(true);
        (0, test_1.expect)(hasUserIndicator, 'User indicator must be visible').toBe(true);
        (0, test_1.expect)(loginDuration, 'Login should complete within 5 seconds').toBeLessThan(5000);
    });
    /**
     ...
     */
    (0, test_1.test)('should show error or remain on login page with invalid credentials', async ({ page, baseURL }) => {
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should remain on login page or show error with invalid credentials').toBeTruthy();
    });
    /**
     ...
     */
    (0, test_1.test)('should reject empty username and password', async ({ page, baseURL }) => {
        // Step 1: Navigate to login page
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject empty credentials').toBeTruthy();
    });
    (0, test_1.test)('should reject empty username with valid password', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject empty username').toBeTruthy();
    });
    (0, test_1.test)('should reject valid username with empty password', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject empty password').toBeTruthy();
    });
    (0, test_1.test)('should reject correct username with incorrect password', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject incorrect password').toBeTruthy();
    });
    (0, test_1.test)('should reject incorrect username with correct password', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject incorrect username').toBeTruthy();
    });
    (0, test_1.test)('should handle username with special characters', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError || !currentURL.includes('login.html'), 'Should handle special characters without crashing').toBeTruthy();
    });
    (0, test_1.test)('should handle password with special characters', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError || !currentURL.includes('login.html'), 'Should handle special characters in password without crashing').toBeTruthy();
    });
    /**
     ...
     */
    (0, test_1.test)('should handle SQL injection attempt in username', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject SQL injection attempt - security validation').toBeTruthy();
    });
    /**
     ...
     */
    (0, test_1.test)('should handle XSS attempt in username', async ({ page, baseURL }) => {
        const loginUrl = baseURL ? `${baseURL.replace(/\/$/, '')}/login.html` : '/login.html';
        await page.goto(loginUrl);
        await page.waitForLoadState('networkidle');
        const usernameField = page.locator('#username, input[name="username"], input[id*="user" i], input[placeholder*="username" i]').first();
        ...
        (0, test_1.expect)(currentURL, 'Should handle XSS payload safely').toBeTruthy();
    });
    (0, test_1.test)('should handle case-sensitive username validation', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
    ...
    (0, test_1.test)('should handle username with leading/trailing whitespace', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
    ...
    (0, test_1.test)('should handle very long username input', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        // Should handle gracefully without crashing
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject or handle long input').toBeTruthy();
    });
    (0, test_1.test)('should handle unicode characters in username', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL, 'Should handle unicode without crashing').toBeTruthy();
    });
    (0, test_1.test)('should handle emoji in username', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL, 'Should handle emoji without crashing').toBeTruthy();
    });
    (0, test_1.test)('should handle rapid multiple login attempts', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL, 'Should handle multiple attempts').toBeTruthy();
    });
    (0, test_1.test)('should validate form field types', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(passwordType, 'Password field should be type="password"').toBe('password');
    ...
    (0, test_1.test)('should handle LDAP injection attempt', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject LDAP injection').toBeTruthy();
    });
    (0, test_1.test)('should handle NoSQL injection attempt', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL.includes('login.html') || hasError, 'Should reject NoSQL injection').toBeTruthy();
    });
    (0, test_1.test)('should handle null bytes in input', async ({ page, baseURL }) => {
        await navigateToLogin(page, baseURL);
        const { usernameField, passwordField, loginButton } = await getLoginFormElements(page);
        await checkFormExists(usernameField);
        await usernameField.waitFor({ state: 'visible', timeout: 10000 });
        ...
        (0, test_1.expect)(currentURL, 'Should handle null bytes without crashing').toBeTruthy();
    });
    /****
     ...
     */
    (0, test_1.test)('should work in CI/GitHub Actions environment', {
        ...
        (0, test_1.expect)(hasError, 'No error in CI environment').toBe(false);
        (0, test_1.expect)(hasSuccessMessage, 'Success message visible in CI').toBe(true);
        (0, test_1.expect)(notOnLoginPage, 'Redirected in CI environment').toBe(true);
        (0, test_1.expect)(hasUserIndicator, 'User indicator visible in CI').toBe(true);
        // Step 10: Performance assertion with environment-specific thresholds
        if (isCI) {
            (0, test_1.expect)(loginDuration, 'Login should complete within 10s in CI').toBeLessThan(10000);
        }
        else {
            (0, test_1.expect)(loginDuration, 'Login should complete within 5s locally').toBeLessThan(5000);
        }
    });
    /**
     ...
     */
    (0, test_1.test)('should handle headless browser mode', async ({ page, baseURL, browserName }) => {
        ...
        (0, test_1.expect)(notOnLoginPage, 'Should work in headless mode').toBe(true);
    });
    /**
     ...
     */
    (0, test_1.test)('should capture and verify screenshots work', async ({ page, baseURL }) => {
        const browserName = test_1.test.info().project.name;
        ...
        (0, test_1.expect)(beforeScreenshot.length, 'Before screenshot should be captured').toBeGreaterThan(0);
        (0, test_1.expect)(afterScreenshot.length, 'After screenshot should be captured').toBeGreaterThan(0);
        (0, test_1.expect)(beforeScreenshot.length, 'Screenshots should be different').not.toBe(afterScreenshot.length);
        // Step 9: Assert strict validation - login must succeed
        (0, test_1.expect)(notOnLoginPage, 'Login should succeed').toBe(true);
    });
});
